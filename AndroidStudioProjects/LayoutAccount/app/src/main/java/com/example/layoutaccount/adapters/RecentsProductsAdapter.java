package com.example.layoutaccount.adapters;
...
import com.example.layoutaccount.databinding.ListItemRecentsSettingBinding;
...
public class RecentsProductsAdapter extends RecyclerView.Adapter<RecentsProductsAdapter.MyViewHolder> {
    ...
    public interface ItemClickListener {
        public void onItemClick(RecentsProductsAdapter.MyViewHolder viewHolder);
    }
