...
public class SharePreference {
    ...
    public static final String LIKED_PRODUCTS_KEY = "LIKED_PRODUCTS_KEY";
    ...
    public static String findPermission() {
        return sharedPreferences.getString(USER_PERMISSION, "FM_02");
    }
