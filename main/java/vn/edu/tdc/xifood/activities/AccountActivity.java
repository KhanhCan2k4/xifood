...
public class AccountActivity extends AppCompatActivity {
    ...
    private void setUserInEditText() {
                ...
                public void onCallback(ArrayList<User> users) {
                    ...
                    if (checkemail == true) {
                        ...
                        if (user.getEmail().equals(binding.emailUser.getText().toString())) {
                            ...
                            binding.emailUser.setText(user.getEmail() == null ? "" : user.getEmail());
        ...
        if (isValidNumericString(binding.phoneNumberUser.getText().toString())) {
            user.setPhoneNumber(binding.phoneNumberUser.getText().toString());
                ...
                binding.phoneNumberUser.setText(user.getPhoneNumber() == null ? "" : user.getPhoneNumber());
        }
    ...
    //bật tắt chỉnh sửa cho người dùng
    ...
    // Kiểm tra chuỗi chứa kí tự đặt biệt
